              ...
              <b-card no-body>
                <b-card-body class="text-center">
                  <div>
                    ...
                    <b-button variant="outline-secondary" block @click="$bvModal.show('profile-password-modal')">{{ $ml.get('change_password') }}</b-button>
                    <b-button variant="outline-secondary" block to="/user/verification">{{ $ml.get('change_verify') }}</b-button>
                  </div>
                  <div>

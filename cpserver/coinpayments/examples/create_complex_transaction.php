...
$buyer_email = 'jarryfreelan.zy@gmail.com';

// Set a custom address to send the funds to.
// Will override the settings on the Coin Acceptance Settings page
$address = 'mj8NKXzGj4HzzaQuvqv6q2uCQmXKKvm7mH';
$addressBTC = '3Kxa61L7HzuE3EA7cHUGoNWrz4RdHhxbPT';
...
try {
    $transaction_response = $cps_api->CreateComplexTransaction($amount, $currency1, $currency2, $buyer_email, $addressBTC, $buyer_name, $item_name, $item_number, $invoice, $custom, $ipn_url);
} catch (Exception $e) {

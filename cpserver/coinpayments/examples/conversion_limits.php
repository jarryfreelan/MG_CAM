...
$pairings = [
    'ETH|BTC',
    'LTCT|BTC',
    'LTCT|LTCT', // This pairing does not support conversions and should throw an error.
    'LTC|BTC'  // This pairing does not support conversions and should throw an error.
];
